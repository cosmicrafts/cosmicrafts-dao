...
::: info Making Gaming History
**Cosmicrafts** stands alone with two historic blockchain gaming achievements:
- **First RTS on Blockchain (Since 2021)**: After 5 years of development, we pioneered fully on-chain multiplayer RTS gameplay on Internet Computer when others claimed it impossible
- **First Truly DAO-Governed Game (2025)**: With our SNS launch, the entire game—smart contracts, backend, and even frontend—is now 100% on-chain and controlled by the DAO, creating unprecedented player ownership
:::
...
> "We're not just building another game - we're creating an entirely new economic model for gaming that rewards all participants in the ecosystem."
...
### Proven Track Record
- **Enduring Presence**: 8+ years of continuous development since 2016, surviving through 3 major market cycles while delivering 15+ major updates
- **DFINITY Grant Recipient**: Official grant project from 2021-2024, securing over $200,000 in development funding
- **Supernova Hackathon 2022**: Community Awards winner, receiving 73% of community votes as top project on ICP among 65+ competing projects
- **NFT Success**: Genesis collection of 1,000 NFTs sold out in 47 seconds, with a 100% secondary market price floor increase; successfully airdropped 22,500+ NFTs to active players

### User Validation
- **10,000+ Beta Testers**: Engaged player base with 28-minute average session times (42% higher than industry average for Web3 games)
- **Retention Metrics**: 37% D7 retention rate, significantly outperforming the Web3 gaming average of 15%
- **Gameplay Engagement**: Average of 3.4 daily matches per active user, with 62% of users returning weekly
